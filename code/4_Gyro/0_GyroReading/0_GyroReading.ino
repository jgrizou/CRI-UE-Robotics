 ...
 *  But I mostly looked and cherry picked code from the library
 *  https://github.com/pololu/zumo-32u4-arduino-library/blob/master/L3G.cpp
 * 
 */
...
void setup()
{
  ...
  //to make the values more stable by applying filters
